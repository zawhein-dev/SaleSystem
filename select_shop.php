              ...
              <a class="nav-link" href="#">
                <span class="d-flex ">
                  ...
                  <span>
                    ...
                    <?php } else { ?>
                      <img src="./assets/userProfile/user.png" style="width: 40px; height: 40px; border-radius: 50%;"
          ...
          <?php
            ...
            while ($category = $categories->fetch_assoc()) { ?>
              <div class="form-check my-3">
                <input class="form-check-input" type="checkbox" value="<?= htmlspecialchars($category['category_id']) ?>" id="category<?= htmlspecialchars($category['category_id']) ?>">
